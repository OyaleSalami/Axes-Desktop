...
namespace AxesCore
{
    ...
    {
        private static string path = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "/Axes/";
        ...
        public void Load()
        {
            ...
            {
                object temp = File.ReadAllBytes(filePath);
                var ji = (Dictionary<string, object>)temp;
            }
        }
